package com.senac.commons.constants;

public class ParamsConstant {
    private ParamsConstant(){}

    // SERVICE PARAMS
    public static final String SERVICE_DESC = "service_description";
    ...
    public static final String RATE = "ratei";
    public static final String RATEF = "ratef";
}
